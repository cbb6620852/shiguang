...
const SOURCES = {
  folate:  ['西兰花', '菠菜', '生菜', '上海青', '青菜', '番茄', '西红柿', '空心菜', '包菜', '芦笋', '牛油果', '柑橘', '蛋黄', '豆腐', '动物肝脏', '肝'],
  calcium: ['牛奶', '豆腐', '嫩豆腐', '虾', '排骨', '海带', '干海带丝', '奶酪', '芝士', '芝麻', '紫菜', '小鱼', '西兰花', '菠菜', '生菜', '上海青', '空心菜', '包菜'],
  iron:    ['牛腩', '牛肉', '猪里脊', '五花肉', '猪肉馅', '肉末', '排骨', '鸡胸肉', '鸡腿', '鸡翅中', '菠菜', '干木耳', '蛋黄', '肝', '血'],
  protein: ['鸡蛋', '鸡胸肉', '牛肉', '牛腩', '猪里脊', '五花肉', '鲈鱼', '虾', '豆腐', '嫩豆腐', '鸡腿', '鸡翅中', '肉末', '猪肉馅', '皮蛋'],
  dha:     ['鲈鱼', '三文鱼', '带鱼', '秋刀鱼', '鳕鱼', '虾', '海带', '紫菜', '核桃', '亚麻'],
  fiber:   ['西兰花', '空心菜', '包菜', '生菜', '上海青', '菠菜', '土豆', '玉米', '小米', '冬瓜', '海带', '干海带丝', '干木耳', '香菇', '白玉菇', '菌菇', '四季豆', '红薯', '燕麦', '全麦'],
  vitc:    ['番茄', '西红柿', '青椒', '西兰花', '橙子', '猕猴桃', '草莓', '菠菜', '上海青', '空心菜', '包菜', '生菜'],
  vitb6:   ['鸡胸肉', '鸡腿', '鸡翅中', '牛腩', '鲈鱼', '土豆', '香蕉', '鹰嘴豆', '蒜'],
  iodine:  ['海带', '干海带丝', '紫菜', '虾', '海鱼', '贝类', '碘盐', '海参'],
};
